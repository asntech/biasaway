...
# html_theme_options = {}
html_theme_options = {
    # 'sticky_navigation': True,  # Set to False to disable the sticky nav
    # while scrolling.
    # 'logo_only': True,  # if we have a html_logo below, this shows /only/ the
    # logo with no title text
}
...
html_title = "A tool to generate composition-matched background sequences"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "BiasAway "+release+" documentation"
...
man_pages = [
    (master_doc, 'BiasAway', u'BiasAway Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'BiasAway', u'BiasAway Documentation',
   author, 'BiasAway',
   'BiasAway is a tool to generate composition-matched background sequences.',
   'Miscellaneous'),
]
